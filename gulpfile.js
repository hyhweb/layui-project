...
gulp.task('watch',function(){
    gulp.watch(['./src/source/libs/**/*','./src/source/images/**/*'], ['build-moveAll']);
   ...
   // gulp.watch(['./src/views/**/*.scss','./src/source/themes/**/*.scss'], ['build-sass']) ;
    gulp.watch(['./src/views/**/*.less','./src/source/themes/**/*.less'], ['build-less']) ;
